...
import be.johanaerens.config.Constants;
import be.johanaerens.domain.User;
import be.johanaerens.repository.UserRepository;
import be.johanaerens.security.AuthoritiesConstants;
import be.johanaerens.service.MailService;
import be.johanaerens.service.UserService;
import be.johanaerens.service.dto.AdminUserDTO;
import be.johanaerens.web.rest.errors.BadRequestAlertException;
import be.johanaerens.web.rest.errors.EmailAlreadyUsedException;
import be.johanaerens.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link be.johanaerens.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
