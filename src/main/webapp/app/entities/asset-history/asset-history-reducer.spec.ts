...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSETHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ASSETHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ASSETHISTORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ASSETHISTORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ASSETHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ASSETHISTORY actions', async () => {
      const arg = 42666;
